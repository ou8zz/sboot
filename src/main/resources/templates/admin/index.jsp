...
<!--   <link media="screen" rel="stylesheet" type="text/css" href="../css/zTreeStyle.css" /> -->
  <style type="text/css">
	.spse {margin-right: 4px;}
  </style>
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          ...
          <li><a href="../bkm_logout"><span class="am-icon-power-off"></span> 退出</a></li>
        </ul>
      </li>
  ...
  <!--     <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="../app/users" class="am-cf"><span class="am-icon-check"></span> 个人资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
...
<script type="text/javascript" src="../script/common/jquery.ztree.core.min.js"></script>
<script type="text/javascript" src="../script/common/jquery.ztree.excheck.min.js"></script>
<script type="text/javascript" src="../script/common/json-2.3.min.js"></script>
<script type="text/javascript" src="../script/admin/index.js"></script>
</body>
</html>
